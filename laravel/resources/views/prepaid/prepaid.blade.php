        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Prepaid Balance || <a href="home">Back</a> To Dashboard</div>

                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="prereview">
                            {{ csrf_field() }}
                            <div class="form-group">
                                <input type="hidden" class="form-control" name="iduser" value="{{ Auth::user()->id }}" required autofocus>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                   <select name="nominal" class="form-control" value="{{ old('value') }}" required>
